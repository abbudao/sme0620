...
%Aula 1
% Todo
% Refazer a parte de seção de organização das duas primeiras aulas
% Lembrar de tirar itemize parar enumerate alf
% Fazer as figuras de diagrama de Venn
% Corrigir erros crassos
% Procurar os \null substituir
...
\item [Exemplo]: Um estudante se inscreve em dois processos seletivos com probabilidade 
 ...
 \end{align*}
 \end{description}
 \subsection{Independência de tres eventos}
 ...
 \begin{align*}
   ...
   =P(A)\times P(\bar{B})
 \end{align*}
 \item [Obs]: Não confundir eventos mutuamente exclusivos com eventos independentes. Ou seja, nao confunda $P(A \cap B)  = 0$ com $ P(A \cap B) = P(A)\times P(B)$.
...
% \end{enumerate}
 ...
 \subsection{Particoes do espaco amostral}
     ...
     \end{enumerate}
   \end{description}
   \subsection{Lema da probabildiade total}
   \begin{description}
 \item [Definicao] Se $A_1,\ldots, A_k$ é uma partição de $\Omega$, então para qualquer evento 
     $B$ de $\Omega$, vale:
   ...
   \end{description}
     ...
     \begin{description}
       \item [Definicao] Se $A_1,A_2,\ldots, A_k$ formam uma partição de $\Omega$ e 
