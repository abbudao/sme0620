...
\begin{description}
      ...
      \item[Casos Particulares]
        \begin{enumerate}
          ...
          \item Se $B \subset A$, então $A \cap B= B$.
            ...
            \begin{figure}[H]
              \centering
              \input{tikz/Probabilidade/figura3.tikz}
          ...
          \item Se $A$ e $B$ são eventos disjuntos ou mutuamente exclusivos (não possui elementos comuns), então $A\cap B = \emptyset$.
            ...
            \begin{figure}[H]
              \centering
              \input{tikz/Probabilidade/figura4.tikz}
              \caption{}
              \label{fig:4}
            \end{figure}
  ...
  \item[Diferença de eventos ($A-B$)] é o evento formado pelos elementos que pertencem a $A$ mas não pertencem a $B$.
    ...
    \begin{figure}[H]
      \centering
      \input{tikz/Probabilidade/figura5.tikz}
      \caption{}
      \label{fig:5}
    \end{figure}
  \item [Evento Complementar ($\bar{A}$ ou $A^c$)] é o evento formado por todos os elementos de $\Omega$ que não pertencem a $A$.
    \begin{description}
      \begin{figure}[H]
        \centering
        \input{tikz/Probabilidade/figura6.tikz}
        \caption{}
        \label{fig:6}
      \end{figure}
    ...
    \item [Alguns exemplos de eventos complementares] 
      ...
      \begin{enumerate}[align=left,label=({\alph*}) ]
        ...
        \item $A \cup B^c = ( A \cap B ) \cup B^c = A \cup (A \cup B)^c$
          \begin{figure}[H]
            \centering
            \input{tikz/Probabilidade/figura9.tikz}
            \caption{}
            \label{figura:9}
        ...
        \item  $A \cap B^c = B^c \cap (A \cup B)$
          \begin{figure}[H]
            \centering
            \input{tikz/Probabilidade/figura10.tikz}
            \caption{}
            \label{fig:10}
          \end{figure}
...
\begin{description}
  ...
  \end{exercise}
    ...
    Sejam $A,B \subset \Omega$. Uma representação bastante útil é a àrvore de probabilidades.
      \begin{figure}[H]
        \centering
        \input{tikz/Probabilidade/tree1.tikz}
        \label{fig:17}
     ...
     No exemplo anterior, qual a probabilidade de um funcionário selecionar um 
      desktop usado?
      \begin{figure}[H]
        \input{tikz/Probabilidade/tree2.tikz}
  ...
  \end{figure}
       ...
       \begin{example}
         ...
         \begin{enumerate}[label=(\alph*)]
           \item $P(C)=$?
             ...
             \begin{align*}
               P(C) = P \left[(A \cap C ) \cup \left(B \cap C \right)\right]\\
   ...
   \begin{description}
     \item [Definição] Seja um experimento aleatório e $\Omega$ o espaço amostral associado 
       ...
       \begin{figure}[H]
         \centering
         \input{tikz/Probabilidade/domain1.tikz}
       ...
       \begin{example}Em uma linha de produção, peças são classificadas em defeituosas ou não
         ...
         \end{obs}       % e $x$ assume um cojjunto de valores finitos.
     \end{example}
 \end{description}
   ...
   \begin{description}
     ...
     \item[Interpretação da f.m.p.\ ] 
       ...
       \begin{figure}[H]
         \centering
         \input{tikz/Probabilidade/fmp1.tikz}
 ...
 \end{description}
   ...
   \begin{description}
     \item [Definição] Seja X uma v.a.\ contínua que assume valores em $R_{x},R_{x} \subset \mathbb{R}$.
       ...
       \begin{figure}[htpb]
         \centering
         \input{tikz/Probabilidade/fmp2.tikz}
...
Isso implica que:
     ...
     \begin{example}
       ...
       \end{enumerate}
     \end{example}
     \begin{example}Seja X uma v.a.\ contínua com f.d.p.\ dada por:
       \begin{align*}
         f(x)= 
         \begin{cases}
       ...
       \item Probabilidade Condicional
             \begin{figure}[H]
               \centering
               \input{tikz/Probabilidade/intersecaxis.tikz}
               \label{fig:26}
             \end{figure}
             \begin{align*}
               P(A/B)= \frac{P(A\cap B)}{P(B)} 
     ...
     \begin{description}
       \item [Definição] Seja $X$ uma v.a.\ discreta que assume valores em $R_{x}$ e com f.m.p.\
         ...
         \begin{example}Conidere o lançamento de uma moeda duas vezes e $X$ é o número de caras. Já sabemos
           ...
           \begin{figure}[H]
             \centering
             \input{tikz/Probabilidade/grafico1.tikz}
...
\begin{obs}$F_{X}(x)= P(X \leq a)= \displaystyle{\int_{-\infty}^{a}f(t) \,\mathrm{d}t}  , \quad a \in \mathbb{R}$\end{obs}
  ...
  \begin{align}  E(aX + b)=aE(X)+ b\end{align}
           ...
           \end{example}           % Exemplo: Seja $X$ uma v.a.\ com f.m.p.\ dada por:
